	...
	public InserirDados() throws SQLException{
		...
		try{
			...
			st.executeUpdate ("INSERT INTO Produto (codProduto, produto) values(1,'Arroz');"
					+ "INSERT INTO Produto (codProduto, produto) values(2,'Feijão');"
					+ "INSERT INTO Produto (codProduto, produto) values(3,'Macarrão');");
		}catch(SQLException eSQL){
		...
		JLabel mensagem = new JLabel("Você acabou de usar INSERT!");
		P.add(mensagem);
	}
